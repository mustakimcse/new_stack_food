...
class FTradesScreen extends StatefulWidget {
  const FTradesScreen({super.key});

  @override
  State<FTradesScreen> createState() => _FTradesScreenState();
}

class _FTradesScreenState extends State<FTradesScreen> {

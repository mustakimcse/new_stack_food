...
import 'package:stack_food/screen/home_item/restaurants_screen.dart';
import 'package:stack_food/screen/home_item/trades_screen.dart';

import 'f_restaurants_screen.dart';
...
class _FHomeScreenState extends State<FHomeScreen> with SingleTickerProviderStateMixin {
                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Image.asset("assets/man/per2.png"),
                                    const SizedBox(width: 10),
                                    const Column(
